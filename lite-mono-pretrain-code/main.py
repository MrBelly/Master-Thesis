...
def get_args_parser():
    ...
    # Model parameters
    parser.add_argument('--model', default='depth_encoder', type=str, metavar='MODEL',
    ...
    # Dataset parameters
    parser.add_argument('--data_path', default='data/ILSVRC2012/imagenet/', type=str,
    ...
    parser.add_argument('--project', default='litemono', type=str,
...
def main(args):
    ...
    model = LiteMono(model="lite-mono", width=256, height=256, layer_scale_init_value=args.layer_scale_init_value)
    model.to(device)
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser('Lite-Mono pretraining code', parents=[get_args_parser()])
