...
class LGFI(nn.Module):
    ...
    def __init__(self, dim, drop_path=0., layer_scale_init_value=1e-6, expan_ratio=6,
        ...
        if (dim==48):
            self.MLP_mixer = S2MLPv2(in_channels = 48, image_size = (48,160), patch_size = [(4,4)],d_model = [48], depth = [1], expansion_factor = [1])
        ...
        if (dim==80):
            self.MLP_mixer = S2MLPv2(in_channels = 80, image_size = (24,80), patch_size = [(4,4)], d_model = [80], depth = [1], expansion_factor = [1])
        ...
        if (dim==128):
            self.MLP_mixer = S2MLPv2(in_channels = 128, image_size = (12,40), patch_size = [(4,4)], d_model = [128], depth = [1], expansion_factor = [1])            
